...
The Confusion Matrix results indicated greater than 99% accuracy (99.1%), giving me confidence that I could use this for the quiz predictions. 
...
This relatively simple approach based on all of the sensor data and only the random forest model showed that greater than 99% accuracy could be achieved. The results for the 20 cases in the test csv file were used in the project quiz and found to be 100% correct.
